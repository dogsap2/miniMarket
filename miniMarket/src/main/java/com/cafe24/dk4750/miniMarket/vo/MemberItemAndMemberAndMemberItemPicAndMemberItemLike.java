...
public class MemberItemAndMemberAndMemberItemPicAndMemberItemLike {
	// 멤버 아이템 속성
	...
	public String toString() {
		return "MemberItemAndMemberAndMemberItemPicAndMemberItemLike [memberItemNo=" + memberItemNo
				...
				+ memberDate + ", memberItemPic1=" + memberItemPic1 + ", likeActive=" + likeActive + "]";
	}
}

...
public class CompanyItemAndCompanyAndCompanyItemPicAndCompanyItemLikeAndCompanyPic {
	// 컴퍼니 아이템 속성
	...
	public String toString() {
		return "CompanyItemAndCompanyAndCompanyItemPicAndCompanyItemLikeAndCompanyPic [companyItemNo=" + companyItemNo
				...
				+ companyEmail + ", companyDate=" + companyDate + ", picNo=" + picNo + ", companyItemPic1="
